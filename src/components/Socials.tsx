...
export default function Socials({ expanded = false }: { expanded?: boolean; }) {
    return (
        <div className={styles.socialsContainer}>
            <div>
                <a href="https://github.com/jtganulin" target="_blank" rel="noopener nofollow noreferrer" title="View my GitHub profile" className={styles.social}><FontAwesomeIcon icon={"fab fa-github" as IconName} fixedWidth /> {expanded && "GitHub"}</a>
            </div>
            <div>
