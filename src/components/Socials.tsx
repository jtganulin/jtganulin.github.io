    ...
    return (
        <div className={styles.socialsContainer}>
            ...
            <div className={styles.socials}>
                <a title="View my GitHub profile" href="https://github.com/jtganulin" className={styles.social} target="_blank" rel="noreferrer"><FontAwesomeIcon icon={"fab fa-github" as IconName} /></a>
                <a title="View my LinkedIn profile" href="#" className={styles.social} target="_blank" rel="noreferrer"><FontAwesomeIcon icon={"fab fa-linkedin" as IconName} /></a>
                <a title="View my Twitter profile" href="#" className={styles.social} target="_blank" rel="noreferrer">`<FontAwesomeIcon icon={"fab fa-twitter" as IconName} /></a>
