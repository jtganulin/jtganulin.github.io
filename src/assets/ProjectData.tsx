...
const PROJECTS_DATA = [
    {
        ...
        description: "This website was developed for The Entryway Surgeons, a company that specializes in the installation and repair of iron, french steel, fiberglass doors, and windows. The website was initially developed using HTML, CSS, JavaScript, jQuery, and PHP with Laravel 8, and was later modernized with Laravel 12, PHP 8, Tailwind CSS v4, and Alpine.js. The site features an admin panel for managing gallery images and user reviews. OAuth-based Google Business Profile synchronization automates customer review ingestion and management. The website is fully responsive and can be viewed on desktop and mobile devices. The site features a gallery of the company's work, a contact form, and a user reviews page.",
        accomplishments: [
            "Modernized a legacy Laravel platform by upgrading the application stack to Laravel 12, PHP 8, Tailwind CSS v4, and Alpine.js, improving maintainability, responsiveness, and frontend performance, boosting audience by 2000 impressions.",
            "Developed and integrated OAuth-based Google Business Profile synchronization services, automating customer review ingestion and management workflows.",
            "Enhanced administrative tooling and content management workflows, reducing weekly operational overhead by several hours.",
            "Improved SEO contributing to increased online visibility and generating more than 20 new customer leads in a competitive market.",
            "Provided ongoing maintenance support and periodic updates, with additional rebranding development planned in future phases.",
            "Designed and developed the original full-stack platform using Laravel 8, PHP, JavaScript, jQuery, HTML5, and CSS3.",
            "Engineered a user review system and multimedia gallery to showcase company work and collect customer feedback.",
            "Developed adjunct scripts using Python and C# to process images for the gallery.",
        ...
        skills: ["HTML", "CSS", "JavaScript", "jQuery", "Alpine.js", "Tailwind", "PHP", "Laravel", "Python", "C#", "SQL", "MySQL", "Sentry", "Git", "GitHub","Communication", "Flexibility", "Adaptability", "Problem Solving", "Critical Thinking", "Quick Learning", "Documentation", "Presentation", "Time Management", "Organization", "Attention to Detail", "Responsibility", "Accountability"],
    },
    {
        slug: "VillageHours",
        title: "VillageHours",
    ...
    },
    {
        ...
        description: "Kitchen Companion is a responsive web app designed originally with the MERN stack for a Master's university project, and later migrated to use TypeScript, Tailwind CSS v4, Redux, PostgreSQL, and Prisma. The app makes it easy to discover and manage recipes, plan meals, and access easy-to-use kitchen timers, shopping lists, and unit conversions. Users can create an account easily using social login, and add and edit their own recipes. Recipes can be tagged with meal types, cuisines, dietary restrictions, and more and can then be searched and filtered by these tags. Integration with an external food information API means users can discover new recipes intuitively using natural language phrases. Planned features include ingredient parsing for automatic recipe scaling, nutrition info tracking, meal planning, social features (e.g. sharing recipes, following other users, etc.), AI integration (Agentically create meal plans based on users' preferences and dietary restrictions, chatbot for recipe suggestions, etc.), parsing of recipes from handwritten notes and other websites via AI & OCR, and a mobile app for on-the-go use. While the idea started as a simple personal recipe tracker, the goal has evolved for it to become a comprehensive kitchen utility system and community cooking platform for users to make their time in the kitchen more efficient and enjoyable, and this goal is in active development.",
        accomplishments: [
            "Originally planned, designed, and developed a full-stack web application using HTML5, CSS3, JavaScript, React, Node.js, Express, and MongoDB. Migrated the application to use TypeScript, Redux, PostgreSQL, and Prisma.",
            "Implemented responsive UI designs into functional React components with custom CSS and Tailwind v4.",
            "Migrated authentication system from manually rolled JWTs to better-auth with OAuth 2.0 integration.",
            "Implemented backend API endpoints using Node.js and Express, to facilitate communication between PostgreSQL and external services to facilitate functional requirements.",
            "Integrated with an external food information REST API to retrieve recipe data and images.",
        ],
        type: "Academic",
        url: "",
        github: "",
        images: ["KitchenCompanion1.webp", "KitchenCompanion2.webp", "KitchenCompanion3.webp", "KitchenCompanion4.webp", "KitchenCompanion5.webp", "KitchenCompanion6.webp"],
        skills: ["HTML", "CSS", "TypeScript", "React", "Node.js", "Express", "PostgreSQL", "Zod", "Prisma", "better-auth", "Turborepo", "Vitest", "Supertest", "Testcontainers", "Nodemailer", "ImageMagick", "Git", "GitHub", "Adobe Photoshop", "REST APIs", "Problem Solving", "Critical Thinking", "Quick Learning", "Creativity", "Documentation", "Time Management", "Organization", "Attention to Detail", "Responsibility", "Flexibility", "Accountability"],
    },
    {
        slug: "Intrepid",
        title: "Intrepid",
